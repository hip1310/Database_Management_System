...
Public Class CRYContractor_Master
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRYContractor_Master.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRYContractor_Master
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRYContractor_Master = New CRYContractor_Master
        rpt.Site = Me.Site
        Return rpt
    End Function
