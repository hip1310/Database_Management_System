...
Public Class RPTMaterial_Used_DW
    Dim cn As SqlConnection
    Dim da As SqlDataAdapter
    Dim ds As Data.DataSet

    Private Sub RPTMaterial_Used_DW_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CRYMate_Used_DW1.SetDataSource(ds)
        CrystalReportViewer1.ReportSource = CRYMate_Used_DW1
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        CrystalReportViewer1.SelectionFormula = "{DataTable1.Date} = '" & dtstr1 & "' "
        CrystalReportViewer1.ReportSource = CRYMate_Used_DW1
